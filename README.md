...
- 참고: https://github.com/hunvreus/clonecn/blob/main/skills-lock.json
...
-  복사한 Gemini API 키값을 'GOOGLE_GENERATIVE_AI_API_KEY=' 에 연결
...
프롬프트:
```
- 유튜브 댓글 수집: YouTube API를 통해 유튜브 비디오 ID로 댓글 가져오기
...
```
---
- ``/Users/choeyujeong/Downloads/578015682-ffb3200c-8703-46c8-bc5d-ab584a1b47a0.png``를 에이전트에 입력하여 디자인 참고 정보 제공
...
>https://github.com/cyj2406/youtube-comment.git 이 곳에 코드 베이스를 업로드해줘
